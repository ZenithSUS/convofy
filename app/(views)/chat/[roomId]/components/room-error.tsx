...
function RoomError({ roomErrorData, handleRefresh }: RoomErrorProps) {
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center bg-linear-to-br from-gray-50 via-white to-gray-50 p-4">
      <div className="w-full max-w-md rounded-2xl border-2 border-red-100 bg-white p-8 shadow-xl">
        ...
        <div className="space-y-3">
          ...
          <Button
            onClick={() => router.back()}
            variant="outline"
            className="w-full border-2 border-gray-200 transition-all duration-300 hover:border-gray-300"
          >
            Go Back
          </Button>
        </div>
