...
function RequestCard({
  ...
  return (
    <div className="flex items-start gap-3 border-b border-gray-100 p-3 transition-colors last:border-b-0 hover:bg-gray-50">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2 flex gap-2">
          <button
            ...
            className="flex flex-1 items-center justify-center gap-1 rounded-md bg-blue-600 px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-blue-700"
          >
          ...
          <button
            ...
            className="flex flex-1 items-center justify-center gap-1 rounded-md bg-gray-200 px-3 py-1.5 text-xs font-medium text-gray-700 transition-colors hover:bg-gray-300"
          >
            <X className="h-3 w-3" />
            Decline
          </button>
